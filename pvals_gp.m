function [p_vals] = pvals_gp(dataLength,k,sigma,theta,KolDPlus,KolDMinus,KolD,CvM,Kuiper,Watson,AD,cut,n)

num_MC = 10^n;
generated = gprnd(k,sigma,theta,num_MC,dataLength);
...
parfor i=1:num_MC
    ...
    CDF = gpcdf(test_data,k,sigma,theta);
