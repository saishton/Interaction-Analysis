function [p_vals] = pvals_gm(dataLength,a,b,KolDPlus,KolDMinus,KolD,CvM,Kuiper,Watson,AD,cut,n)

num_MC = 10^n;
generated = gamrnd(a,b,num_MC,dataLength);
