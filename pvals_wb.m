function [p_vals] = pvals_wb(dataLength,a,b,KolDPlus,KolDMinus,KolD,CvM,Kuiper,Watson,AD,cut,n)

num_MC = 10^n;
generated = wblrnd(a,b,num_MC,dataLength);
